...
**Arquivos envolvidos:** `assets/svg/hero/hero.svg`, `docs/hero.md` e, na integração futura, `README.md`. Possíveis fallbacks ficarão em `assets/images/` e animações em `assets/animations/hero/`.
